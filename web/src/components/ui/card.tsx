...
function Card({ className, ...props }: React.ComponentProps<'div'>) { return <div data-slot="card" className={cn('rounded-2xl border border-[#e8e8e8] bg-white shadow-[0_3px_20px_rgba(36,36,36,.035)]', className)} {...props} /> }
